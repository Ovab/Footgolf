...
<head>
    ...
    <title>Footgolf - Home english</title>
    ...
    <div class="wrapper">
        ...
        <div class="container" id="spelregels">
            ...
            <div class="box3"><img class="icon" src="img/Footgolf-Badge-1.png"><br>
                <p>
                    If an obstacle is missed put the ball 3m before the obstacle <br>If the ball lands in the un mowed
                    grass
        ...
        <div class="container containter2" id="reservation">
            ...
            <a href="php/Groep/Holes_aantal.html" style="text-decoration: none">
                ...
                if (isset($_SESSION['groepLead'])) {
                    echo "
            <a href='../EN/php/Funcs/Group_manager.php' style='text-decoration: none'>
