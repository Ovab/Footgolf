        ...
        <div class="signin-signup">
            <form action="del-back.php" class="sign-in-form" method="post">
                <h2 class="title">Delete account</h2>
                    <h3 style="color: #444">Sorry you want to delete your account, please enter the email associated with the account</h3>
                <?php
                session_start();
                ...
                <label>Confirm</label><input type="checkbox" class="btn" value="false" name="confirm">
                <br>
                <input type="submit" class="btn" style= "color: #EC1C24;" value="Delete account"/>
            </form>
            <p id="pc"></p>
